...
const [invoiceVisible, setInvoiceVisible] = useState(false);
    ...
    const handlePlaceOrder = async () => {
      const requiredFields = ['email', 'billingAddress', 'billingState', 'billingZip'];
...
<div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
  ...
  <br></br>
  <p className="text-center text-gray-500">Enter Card Details if you wish to proceed with Card</p>
  <p className="text-center text-gray-500">Or</p>
  <p className="text-center text-gray-500">Place Order Directly</p>
  <div className="">
  ...
  {checkoutStarted && (
    <>
      {invoiceVisible && <InvoiceComponent orderDetails={orderDetails} cartItems={cartItems} totalCost={totalCost} />}
