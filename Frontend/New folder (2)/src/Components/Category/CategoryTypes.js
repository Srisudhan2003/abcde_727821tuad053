    ...
    <div>
      ...
      <div className="bg-white mt-[-4%]">
        <div className="max-w-xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          {categories.length === 0 ? (
            <Link to="/login"><button className="mt-8 text-lg font-semibold text-gray-700 bg-transparent hover:bg-yellow-500 hover:text-white py-2 px-4 border border-red-500 hover:border-transparent rounded">Login to view categories</button></Link>
          ) : (
