    ...
    <div className="bg-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
        ...
        <div className='pb-4'>
          ...
          <p className="text-center text-gray-600 textbase mt-12 mb-[-1%]">Didn’t find the answer you are looking for? <a href="/contactus" title="" className="font-medium text-yellow-500 transition-all duration-200 hover:text-yelllow-800 focus:text-yellow-700 hover:underline">Contact our support</a></p>
          </div>
          </div>
    <Footer/> 
    </div>
