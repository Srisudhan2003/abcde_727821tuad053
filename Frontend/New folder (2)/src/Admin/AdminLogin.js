...
import gifBackground from "../Images/jet_animation.gif"
...
const AdminLogin = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex items-center justify-center bg-gradient-to-r" style={{ backgroundImage: `url(${gifBackground})`, backgroundSize: 'cover' }}>
